...
exports.index = asyncHandler(async (req, res, next) => {
  // Get details of books, book instances, authors and genre counts (in paralell)
  const [
    numBooks,
    numBookInstances,
...
exports.book_detail = asyncHandler(async (req, res, next) => {
  // Get details of books and book instances for specfic book
...
exports.book_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are errors. Render form again with sanitized values/error mesages.
